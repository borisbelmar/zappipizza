...
type Props = SVGProps<SVGSVGElement> & { eatsColor?: string; uberColor?: string }

export default function UberEatsLogo({
  eatsColor = '#5fb709',
  uberColor = '#262626',
  ...props
}: Props) {
